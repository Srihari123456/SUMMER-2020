...
\hhline{|--|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{$\begin{pmatrix}{1.73\\-0.99}\end{pmatrix}$}}}
	%{$\myvec{4.472\\2.236}$}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{$\begin{pmatrix}{-0.99\\1.73}\end{pmatrix}$}}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|--|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{\textbf{$\begin{pmatrix}{0.36\\-1.36}\end{pmatrix}$}}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
